...
const EconomySimulator = () => {
  ...
  const calculateEconomy = () => {
    ...
    // Custo do agente IA (exemplo baseado na complexidade)
    const aiAgentCost = Math.max(800, employees * 400); // Mínimo R$ 800, ou R$ 400 por funcionário substituído
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <Card className="glass-effect tech-card">
            ...
            <CardContent className="space-y-6">
              <div>
                <Label htmlFor="employees">Número de Funcionários a Substituir</Label>
                <Input
                  id="employees"
                  type="number"
                  min="1"
              ...
              <div>
                <Label htmlFor="hours">Horas de Trabalho por Dia</Label>
                <Input
                  id="hours"
                  type="number"
                  min="4"
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-red-500/10 rounded-lg">
                    <div className="text-sm text-foreground/70">Custo Atual (CLT)</div>
                  ...
                  <div className="text-center p-4 bg-green-500/10 rounded-lg">
                    <div className="text-sm text-foreground/70">Custo com IA</div>
                ...
                <div className="text-center p-6 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-500/20">
                  <div className="text-sm text-foreground/70 mb-2">Economia Mensal</div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <div className="text-center">
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-sm text-foreground/70">ROI Anual</span>
                    </div>
                  ...
                  <div className="text-center">
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-sm text-foreground/70">Break-even</span>
                    </div>
                ...
                <div className="text-center pt-4 border-t border-foreground/10">
                  <div className="text-sm text-foreground/70 mb-1">Aumento de Disponibilidade</div>
